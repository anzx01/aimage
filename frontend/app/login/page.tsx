              ...
              <div className="relative backdrop-blur-xl rounded-3xl p-10 border" style={{ background: 'rgba(26, 31, 53, 0.6)', borderColor: 'rgba(217, 158, 70, 0.2)' }}>
                ...
                <div className="relative">
                  ...
                  <div className="flex items-center gap-4 my-6">
                    <div className="flex-1 h-px" style={{ background: 'rgba(139, 155, 181, 0.2)' }} />
                    <span className="text-xs uppercase tracking-wider" style={{ fontFamily: 'DM Sans, sans-serif', color: '#8B9BB5' }}>或</span>
                    <div className="flex-1 h-px" style={{ background: 'rgba(139, 155, 181, 0.2)' }} />
                  </div>
                  ...
                  <button
                    ...
                    className="w-full px-8 py-4 rounded-xl font-semibold tracking-wide transition-all duration-300 hover:shadow-lg hover:-translate-y-0.5 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-3"
                    style={{
                      fontFamily: 'DM Sans, sans-serif',
                  ...
                  >
                    ...
                    <span>{githubLoading ? '跳转中...' : '使用 GitHub 登录'}</span>
                  </button>
